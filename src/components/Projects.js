...
const projects = [
  {
    ...
    "description": "A group project made as part of the Le Wagon web development bootcamp.\nThis was an idea I pitched to the group - a web app designed to make it easier to eat local, seasonal produce by showing inspiring recipes whose main ingredients are currently in season.\nSelect recipes you like and add the ingredients to your shopping list.\nMade on Ruby on Rails by,\nme - Full stack developer\nDaniel Turkington - full stack developer\n\nNaomi Kelly - Full stack developer",
    "link": "http://www.turningseasons.co.uk/",
    "video": turningseasons
  },
  {
    "title": "Jokester",
    "description": "My first ReactJS app.<br>This is a simple app that loads 10 random jokes from an api.",
    "link": "",
    "video": jokester
  },
   {
    "title": "Mister Cocktail",
    "description": "A cocktail recipe app that I built using Ruby on Rails.<br>A simple app where you can add your own cocktails and add ingredients.",
...
//     } else setActiveProject(projects[index + 1])
//   };
    ...
    return (
      <div>
        ...
        <div className="project-buttons">
          <Link href="/">
            <svg className="close" width="243px" height="100px" viewBox="0 0 243 208" version="1.1">
              <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
                <g id="Group-3" transform="translate(10.710938, 10.117188)" stroke="#000000" strokeWidth="20">
          ...
          <svg onClick={this.toggle} className="next-button" width="416px" height="100px" viewBox="0 0 416 275" version="1.1">
            <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
